...
export const Fourth = () => {
  return (
    <div className='fourth-article'>
      <br />
      <h1 style={{ color: '#c69c69' }}>Top Five Reasons why Entrepreneurs Fail</h1>
      <br />
