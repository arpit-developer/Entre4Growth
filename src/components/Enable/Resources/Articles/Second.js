  ...
  return (
    <div className='second-article'>
      ...
      <ul>
        ...
        <li>Legal tools. These kinds of legal websites can offer tools such as business formation documents, trademark, copyright and patent information, as well as annual reports that you’ll need to file and more.</li>
      ...
      <h3 style={{ color: "red" }}>3. Find an accountant.</h3>
      <p>
        Even if you plan on doing business bookkeeping yourself, getting a good accountant is worth the price. Who has time to keep up to date on tax law changes? You sure don’t — but accountants do. Not only can they ensure you take advantage of any tax breaks, but they can also provide valuable advice on how to structure your business, the best way to finance business expansion, and how much you should pay yourself. During your startup phase, an accountant can help you assess your financing needs, advise whether your financial projections are realistic, and help you assemble documentation and a presentation that will convince investors and lenders to finance you.
      </p>
      <h3 style={{ color: "yellow" }}>4. Buy business insurance.</h3>
      <p>
      ...
      <h3 style={{ color: "purple" }}>5. Be smart about new customers and clients.</h3>
      <p>Small business owners can face cash flow issues due to late or unpaid invoices. Fortunately, there are some things you can do to mitigate the risk.</p>
      <ul>
      ...
      <h3 style={{ color: "olive" }}>6. Protect your employees.</h3>
      <p>From an electrical fire that destroys your inventory to a natural disaster like a flood or hurricane, disaster can strike your business at any time. That’s why having a disaster plan for what you will do in an emergency is important. A good disaster plan protects both your business and your people. Create a plan and assign responsibilities for how to get employees and customers out of the building safely, what to do if a disaster keeps you and employees from getting to your business, and how you will keep running even if you can't get to your physical location. Ready.gov, an official website of the U.S. Department of Homeland Security, offers business disaster toolkits for hurricanes, earthquakes, flooding, power outages and other types of hazards.</p>
      <h3 style={{ color: "orange" }}>7. Protect your business data.</h3>
      <p>
        Cyber threats are on the rise, and small businesses are frequent targets. To protect your business, start by backing up your company data and documents and storing them securely. A cloud-based file storage solution keeps your data safe off-site and accessible no matter where you are. To protect your business from cybercrime and hackers, install appropriate firewalls, use business-grade computers and antivirus software, and train your employees in cyber security measures, such as creating strong passwords. SCORE’s Small Business Guide to Cyber Security can help you get started. Your SCORE mentor can help you determine additional ways to manage risks and protect your business.
      </p>
    </div>
  );
};
